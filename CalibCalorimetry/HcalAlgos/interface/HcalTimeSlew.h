...
class HcalTimeSlew {
 public:
  ...
  static constexpr double tspar[2] = {12.2999, -2.19142};
  ...
  static double delay(double fC, ParaSource source=InputPars, BiasSetting bias=Medium, double par0=tspar[0], double par1=tspar[1]);
};
